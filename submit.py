# Using Neuroevolutionary methods [instead of]/with Reinforcement Learning (paradox?) 
# creds to my friend https://github.com/normandipalo/learn-to-walk-with-genetic-algs
